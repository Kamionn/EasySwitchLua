...
--- Generated:  04-05-2026 (day-month-year)
---
...
local _M_compat, _M_bigint, _M_map, _M_set, _M_p, _M_compile, _M_walk, _M_match, _M_dsl_ast, _M_dsl_lex, _M_dsl_parse, _M_dsl_eval, _M_dsl_comp, _M_parsePat, _M_matcher
...
local p = _M_p
local matchMod = _M_match
local walkMod = _M_walk
local matcherMod = _M_matcher
